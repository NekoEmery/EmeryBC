...
export class EBCDrawer {
    ...
    private renderPalettes(body: HTMLElement): void {
        ...
        const render = (): void => {
            ...
            colorPicker.value = selectedColor ?? "#cf6f98";
            ...
            if (selectedColor) {
                ...
                selBar.appendChild(dot); selBar.appendChild(txt); selBar.appendChild(clrBtn);
            } else {
                const hint = document.createElement("span");
                hint.style.cssText = "font-family:'Trebuchet MS',serif;font-size:9px;color:#4a2a3a;";
            ...
            div1.className = "ebc-divider"; div1.style.margin = "0 0 6px";
