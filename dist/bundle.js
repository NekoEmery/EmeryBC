...
`;
    ...
    class EBCDrawer {
        ...
        renderButtons() {
            var _a;
            const grid = (_a = this.el) === null || _a === void 0 ? void 0 : _a.querySelector("#ebc-grid");
            if (!grid)
                return;
            ...
            grid.querySelectorAll(".ebc-btn").forEach(btn => {
                btn.addEventListener("click", () => {
                    var _a;
                    const emote = (_a = btn.dataset.emote) !== null && _a !== void 0 ? _a : "";
                    if (emote)
                        ServerSend("ChatRoomChat", { Content: emote.trim(), Type: "Emote" });
                });
            });
        }
        // ── Open / Close / Toggle ─────────────────────────────────────────────────
